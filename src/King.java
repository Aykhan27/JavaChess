public class King extends Piece {
    ...
    public int castle(String side) {
        ...
        if (!Board.isPathClear(this.getX(), this.getY(), rook.getX(), rook.getY())) {
    ...
    public boolean canMove() {
        ...
        if (this.testMove(x - 1, y - 1) || this.testMove(x + 1, y - 1)
                || this.testMove(x - 1, y + 1) || this.testMove(x + 1, y + 1)) {
            return true;
        }

        // rook-like movement
        if (this.testMove(x - 1, y) || this.testMove(x + 1, y)
                || this.testMove(x, y + 1) || this.testMove(x, y - 1)) {
            return true;
        }
